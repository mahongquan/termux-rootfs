...
To use this rootfs, you need to build package by executing command:

  $ dpkg-deb -b termux-rootfs termux-rootfs.deb

Then you need to install it with:

  $ dpkg -i termux-rootfs.deb

After that you need to restart Termux app, and run command 'termux-setup-rootfs'.
...
* Termux (Termux:Boot, Termux:Styling, Termux:Widget are integrated)
  APK is located at ./termux-rootfs/data/data/com.termux/files/usr/share/doc/termux-rootfs/Termux.apk

* Termux:API
  APK is located at ./termux-rootfs/data/data/com.termux/files/usr/share/doc/termux-rootfs/TermuxAPI.apk
...
admin tools:
  ...
  httping, iproute2, iperf3, iw, macchanger, ngrep, nmap, proot, sensors,
  sslscan, sipcalc, tcpdump, tracepath, whois, wireless-tools
...
generic utilities:
  ...
  gettext, global, grep, inetutils, info, less, man, mapscii, mktorrent,
...
pentesting & cracking:
  aircrack-ng, bettercap, fcrackzip, hping3, hydra, john, mdk3,
  metasploit-framework, pkcrack, reaver, udp-amplified-m
